...
def send_activation_link(user):
    ...
    url = "http://localhost:8000/hotelcom/profile/activate/" + activation_link
    msg = "Hi"
    msg += "\n"
    msg += "\n"
    if user.gender == "man":
    ...
    msg += "\n"
    msg += "Thank you for your registration. You can click on the following link to activate your account.."
    msg += "\n"
    msg += "\n"
    msg += url

    subject = "Activation"
    sender = 'hotelcom@gmail.com'
...
def send_password_link(user):
    url = "http://localhost:8000/hotelcom/forgotpassword/" + user.username
    msg = "Click on the following link a new password will be sent to your email."
    msg += "\n"
    msg += url
...
def send_new_password(user):
    ...
    msg += str(new_pass)
    msg += "\n\n"
    msg += "You can change your password by visiting the link below"
    msg += "\n\n"
    msg += "http://localhost/hotelcom/profile/changepassword"
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            try:
                ...
                return render(request, "thanks.html", {'message': "Change password link sent to your email.", "redir": "/hotelcom/home/"})
            except Guest.DoesNotExist:
                return render(request, "thanks.html", {'message': "Username is not available. Please try again.", 'redir': "/hotelcom/sendusername/"})
    else:
        form = ForgotForm()
    return render(request, "Login.html", {'form': form, 'value': 'New password', 'option': 0})
...
def forgot_password(request, username=""):
    ...
    try:
        ...
        return render(request, "thanks.html", { 'message':'New password sent to your email.', 'redir': '/hotelcom/login'})
    except Guest.DoesNotExist:
        return render(request, "thanks.html", {'message':'Your link is invalid. Please try again.', 'redir': '/hotelcom/login'})
...
def change_password(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            user.save()
            return render(request, "thanks.html", {'message': 'Your password was changed.','redir': '/hotelcom/home/'} )
    else:
        form = ChangePassword(username=username)
    return render(request, 'Login.html', {'form': form, 'value':"change Password", 'option': 1})
...
def activate_account(request, activation_url):
    try:
        ...
        return render(request, 'thanks.html', {'message': "The activation link is wrong."})

    return render(request, 'thanks.html', {'message': 'Your account has been activated. Can login.', 'redir': '/hotelcom/login'})
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            return render(request, 'thanks.html', {
                'message': 'Thank you for your registration. To activate your account go to e-mail.',
            })
    else:
        form = RegisterForm()
    return render(request, "register.html", {'form': form})

@login_required(login_url='/hotelcom/login/')
def edit_profile(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            user.save()
            return render(request, "thanks.html", {'message': 'Changes saved successfully.', 'redir': '/hotelcom/profile/'})
        else:
            print("valid nist")
    else:
...
def my_login(request):
    ...
    if request.method == "POST":
        ...
        form = LoginForm()
    return render(request, "Login.html", {'form': form, 'message': message, 'value':"Login", 'option': 1})


@login_required(login_url='/hotelcom/login/')
def my_logout(request):
    logout(request)
    return HttpResponseRedirect("/hotelcom/home")
...
def add_hotel(request):
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            hotel.save()
            return render(request, "thanks.html", {'message': 'Your hotel was registered.', 'redir': '/hotelcom/profile/hotels_list/'})
    else:
        form = HotelForm()
...
def add_room(request, hotel_id):
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            room.save()
            return render(request, 'thanks.html', {'message': "The room was registered to", 'redir': '/hotelcom/edit/hotel/'+ hotel_id})
    else:
        form = RoomForm()
    ...
    try:
        ...
        if request.method == "POST":
            ...
            if form.is_valid():
                ...
                hotel.save()
                return render(request, 'thanks.html', {'message': "All new hotels have been registered successfully", 'redir': '/hotelcom/edit/hotel/'+ hotelID})
        else:
        ...
        return render(request, 'thanks.html', {'message': "The hotel does not exist.", 'redir' : '/hotelcom/profile/'})
    ...
    try:
        ...
        if request.method == "POST":
            ...
            if form.is_valid():
                ...
                room.save()
                return render(request, 'thanks.html', {'message': "New reservation has been registered successfully.", 'redir': '/hotelcom/edit/room/'+ roomID})
        else:
        ...
        return render(request, 'thanks.html', {'message': "Room does not exist.", 'redir' : '/hotelcom/profile/'})
...
def hotel_profile(request, hotel_id):
    ...
    try:
        ...
        return render(request, 'thanks.html', {'message': "The hotel does not exist.", 'redir' : '/hotelcom/home/'})
...
def room_profile(request, room_id):
    try:
        ...
        return render(request, 'thanks.html', {'message': "Room does not exist.", 'redir' : '/hotelcom/home/'})
...
def bank(request, payType, payID):
    if payType == '0':
        ...
        url = '/hotelcom/pay/commision/' + str(payID)
        print("bebin injam alan :|")
    else:
        reserve = Reservation.objects.get(pk=payID)
        if check_valid_reservation(reserve) == False:
            return render(request, 'thanks.html', {'message': '30 minutes past the time of booking and the reservation is canceled.', 'redir':'/hotelcom/profile/my_reservation/'})
        else:
            payment = Reservation.objects.get(pk=payID).total_cost
            url = '/hotelcom/pay/reservation/' + str(payID)
...
def pay_commision(request, commisionId):
    ...
    commision.save()
    return render(request, 'thanks.html', {
        'message':'This month you have a commision on reservation.',
        'redir':'/hotelcom/profile/commision/'
    })
...
def pay_reservation(request, reservationId):
    ...
    if commisions :
        ...
        my_com.save()
    return render(request, 'thanks.html', {
        'message':'Your booking fee has been paid successfully.',
        'redir':'/hotelcom/profile/my_reservation/'
    })
...
def ajax_home(request):
    ...
    for hotel in hotels:
        ...
        a['link'] = "/hotelcom/profile/hotel/" + str(hotel.id)
