...
def hoteliers_only(view):
    ...
    def new_view(request, *args, **kwargs):
        ...
        return render(request, 'thanks.html', {'message': 'You are not allowed to do these changes.', 'redir' : '/hotelcom/home/'})
...
def specific_hotelier_only(view):
    ...
    def new_view(request, hotel_id):
        ...
        try:
            ...
            if hotelier != id:
                return render(request, 'thanks.html', {'message': 'You are not allowed to do these changes.', 'redir' : '/hotelcom/profile/'})
            else:
        ...
        def new_view(request, *args, **kwargs):
            ...
            try:
                ...
                return render(request, 'thanks.html', {
                    'message': 'You are not allowed to do these changes.',
                    'redir' : '/hotelcom/home/'
                })
