...
def search_room(request):
    ...
    for room in rooms:
        ...
        a['link'] = "/hotelcom/profile/room/" + str(room.id)
...
def transaction(request, reserveId):
    try:
        ...
        if reserve_.status == 1:
            return HttpResponse("Payment has already been done")
        else:
        ...
        return HttpResponse("Given booking specifications are not found.")
